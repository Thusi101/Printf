...
return (write(1, &buff[BUFF_SIZE - i - 1], width - 1) + write(1, &buff[0], 1));
}
...
int write_number(int is_negative, int ind, char buff[], int warns, int width, int precision, int size)
{
